            ...
            if(row4[i].contains("://")) {
                ...
                itemLayout.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        getContextAlt().startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(row4[fi])));
                    }
                });
            }

            itemLayout.setBackgroundColor(ColorUtil.getColor(R.color.grey_50, getContextAlt()));
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    switch(event.getAction()) {
                        ...
                        case MotionEvent.ACTION_DOWN:
                            v.setBackgroundColor(ColorUtil.getColor(R.color.grey_300, getContextAlt()));
                            break;
                        case MotionEvent.ACTION_HOVER_EXIT:
                        case MotionEvent.ACTION_CANCEL:
                        case MotionEvent.ACTION_OUTSIDE:
                        case MotionEvent.ACTION_UP:
                            v.setBackgroundColor(ColorUtil.getColor(R.color.grey_50, getContextAlt()));
                            break;
                        default: break;
                    }
                    return false;
    ...
    public static void showDialogUsingPreference(Preference preference, @ArrayRes final int res, final Activity activity) {
        preference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                showDialog(res, activity);
                return false;
            }
        });
    }

    public static void showDialog(@ArrayRes final int res, final Activity activity) {
