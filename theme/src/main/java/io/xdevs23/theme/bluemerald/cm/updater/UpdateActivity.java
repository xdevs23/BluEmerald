...
public class UpdateActivity extends XquidCompatActivity {
    ...
    protected void initViews() {
        ...
        com.rey.material.widget.Button tlButton
                = (com.rey.material.widget.Button)findViewById(R.id.updaterTlCreditsBtn);
        assert tlButton != null;
        tlButton.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        EasyListView4.showDialog(R.array.credits_translation_list, thisActivity);
                    }
                }
        );
    }
